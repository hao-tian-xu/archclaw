...
1. **Detect** — When Jackie mentions project-related details in conversation, identify which project and what changed.
...
When a new conversation starts and Jackie asks about a project, read the full project file and summarize:
...
No re-explanation needed from Jackie — the project file is the source of truth.
...
- **One source of truth.** The project file is canonical. If Jackie contradicts something in the file, update the file — don't argue.
